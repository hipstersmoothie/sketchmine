...
const svg = `<svg width="100" height="89px" xmlns="http://www.w3.org/2000/svg">
<path d="M1.22684875,0.519741969 L51.2071068,50.5 L22.5,50.5 L22.5,77.7567332 C40.7717243,92.0653574 49.5,92.0167519 49.5,78 C49.5,77.1164626 50.5702016,76.7903659 53.444274,76.3615728 C54.5990929,76.1892813 60.879171,75.4149286 62.7441332,75.1553294 C67.2583646,74.526957 71.1586221,73.8199563 74.8787322,72.8899287 C90.5387638,68.9749208 99.5,61.8955443 99.5,50 C99.5,37.6789254 83.7971904,25.3730501 58.0625102,14.9635165 C38.0878107,6.88386281 13.6498928,0.904830312 1.22684875,0.519741969 Z M50.4960568,78.0656313 C50.4973813,78.0512192 50.5,78.0294337 50.5,78 C50.5,78.0145312 50.4999911,78.0290486 50.4999732,78.0435522 Z" id="Path"></path>
<circle cx="50" cy="50" r="50" fill="#D8D8D8" fill-rule="evenodd"/>
</svg>`;
...
// const svgSize: IBounding = {height: 63, width: 72, x: 0, y: 0};
